...
function ChatboxComponent() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setResponses(prevResponses => [...prevResponses, { role: 'user', content: inputText }, { role: 'bot', content: receivedResponse }]);
            
        } catch (error) {
            console.error("Error fetching data:", error.message ? error.message : error, data);
